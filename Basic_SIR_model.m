...
function dydt = myODE(t, y)
    ...
    beta_2 = 2.5e-6; %1.87e-5*2.5
    beta_3 = 2.5e-6; %9.35e-6*2.5
    beta_4 = 2.5e-6; % 4.67e-6*2.5
    gamma_1 = 0.886/5; % recovery rate from Omega
    gamma_2 = 0.886/5;
    gamma_3 = 0.886/5;
    gamma_4 = 0.886/5;
    ...
    dydt = [-1*beta_1*S_1 *(I)-1*nat_death_1*(S_1)-V_1;
        ...
        nat_death_1*(S_1+I_1+R_1);
        nat_death_2*(S_2+I_2+R_2);
        nat_death_3*(S_3+I_3+R_3);
        nat_death_4*(S_4+I_4+R_4);];
end
